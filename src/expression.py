...
def FER_live_cam():
    ...
    model = cv2.dnn.readNetFromONNX('./models/RFB-320/emotion-ferplus-8.onnx')

    # Read the Caffe face detector.
    model_path = './models/RFB-320/RFB-320.caffemodel'
    proto_path = './models/RFB-320/RFB-320.prototxt'
